        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorEmail = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    IconName = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    CoverPhoto = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
                    Template = table.Column<string>(type: "nTEXT", nullable: false),
                    Attributes = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    ...
                    Status = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 1),
                    ViewPath = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    LastUpdated = table.Column<DateTime>(type: "TEXT", nullable: true),
