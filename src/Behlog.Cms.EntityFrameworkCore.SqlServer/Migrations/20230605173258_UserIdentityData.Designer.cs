...
namespace Behlog.Cms.EntityFrameworkCore.SqlServer.Migrations
{
    ...
    [Migration("20230605173258_UserIdentityData")]
    partial class UserIdentityData
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Behlog.Cms.Domain.Comment", b =>
                {
                    ...
                    b.Property<string>("LastUpdatedByUserDisplayName")
                        .HasMaxLength(500)
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("Behlog.Cms.Domain.Content", b =>
                {
                    ...
                    b.Property<string>("AuthorUserDisplayName")
                        .HasMaxLength(256)
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(256)");
            ...
            modelBuilder.Entity("Behlog.Cms.Domain.ContentTypeTag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasIndex("TagId", "ContentTypeId")
                        .IsUnique();

                    b.ToTable("ContentTypeTag", (string)null);
                });
            ...
            modelBuilder.Entity("Behlog.Cms.Domain.FileUpload", b =>
                {
                    ...
                    b.Property<long?>("AltFileSize")
                        .HasColumnType("bigint");

                    b.Property<string>("AltFileUrl")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("Behlog.Cms.Domain.Website", b =>
                {
                    ...
                    b.Property<string>("OwneruserDisplayName")
                        .HasMaxLength(500)
                        .IsUnicode(true)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("Behlog.Cms.Domain.WebsiteTag", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.HasIndex("TagId", "WebsiteId", "ContentId")
                        .IsUnique();

                    b.ToTable("WebsiteTag", (string)null);
                });
            ...
            modelBuilder.Entity("Behlog.Cms.Domain.Content", b =>
                {
                    ...
                    b.OwnsMany("Behlog.Cms.ContentAuthor", "Authors", b1 =>
                        {
                            b1.Property<long>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint");
                            ...
                            b1.ToTable("ContentAuthor", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("ContentId");
                        });

                    b.OwnsMany("Behlog.Cms.Contents.ContentHistory", "Histories", b1 =>
                        {
                            b1.Property<long>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint");
                            ...
                            b1.ToTable("ContentHistory", (string)null);
